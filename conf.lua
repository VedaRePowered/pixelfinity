...
--  thing						value				comment
	t.identity =				".pixelfinity"		-- The name of the save directory (string)
	...
	t.window.title =			"Pixelfinity"		-- The window title (string)
	...
	t.window.x = 				320					-- The x-coordinate of the window's position in the specified display (number)
